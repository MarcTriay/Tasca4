...
CREATE TABLE IF NOT EXISTS `MER5`.`Vehicle` (
  ...
  `tipos_vehicle_id` INT NOT NULL,
  `tipos_vehicle_id1` INT NOT NULL,
  PRIMARY KEY (`matricula`, `tipos_vehicle_id`),
...
CREATE TABLE IF NOT EXISTS `MER5`.`Client_Vehicle` (
  ...
  CONSTRAINT `fk_Client_Vehicle_Vehicle1`
    FOREIGN KEY (`Vehicle_matricula` , `Vehicle_tipos_vehicle_id`)
    REFERENCES `MER5`.`Vehicle` (`matricula` , `tipos_vehicle_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
